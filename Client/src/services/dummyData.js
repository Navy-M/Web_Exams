...
export const jobRequirements = {
  "ناوبری و فرماندهی کشتی": {
    ...
    education: ["BSc Nautical Science", "Marine Navigation Academy"],
  ...
  "مهندسی مکانیک و موتور دریایی": {
    ...
    education: ["BSc Marine Engineering", "Mechanical Engineering + CoC"],
    experienceMinYears: 1,
  ...
  "مهندسی برق و الکترونیک دریایی": {
    ...
    education: ["BSc Electrical/Electronic/Marine Engineering"],
    experienceMinYears: 1,
    languages: [{ lang: "English", level: "B2+" }],
  ...
  "تفنگدار دریایی": {
    ...
    education: ["Military/Police Background (مزیت)"],
